...
class TopViewModel(private val postRepository: PostRepository) : ViewModel() {
    ...
    private fun loadNextTopPosts() {
        viewModelScope.launch(Dispatchers.Default) {
            postRepository.getTopResult(pageNumber, Constants.PAGE_SIZE)
                .collect {
                    when (it.status) {
